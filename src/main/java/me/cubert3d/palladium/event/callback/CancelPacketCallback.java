...
public interface CancelPacketCallback {

    Event<CancelPacketCallback> EVENT = EventFactory.createArrayBacked(CancelPacketCallback.class,
            listeners -> packet -> {
                for (CancelPacketCallback listener : listeners) {
